...
In all cases, the \acp{CNN} are trained until convergence. Due to the diversity of applied networks and differing dataset sizes, training settings are numerous and optimized in each case with the validation data. Convergence occurs after 1,000 to 80,000 training iterations with a batch-size between 1 for the Faster R-CNN detector and 32 for the VGG16 training. 
